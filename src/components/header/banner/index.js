...
const BannerCaption = ({ heading, subheading }) => (
  <div className="banner-caption flex flex-col w-full justify-center items-center relative p-8 text-center md:mb-14 xl:mt-14">
    {/* heading */}
    <h1 className="text-5xl lg:w-full md:w-3/5 w-full title-font font-display leading-relaxed mt-20 lg:mt-10 xl:mt-0 mb-8 md:mb-0 text-white">
      {heading ? heading : `A Different Travel Experience`}
    </h1>
    {/* end heading */}

    {/* subheading */}
    <p className="mx-auto tracking-widest text-xs leading-relaxed text-indigo-100 ">
      {subheading
        ? subheading
